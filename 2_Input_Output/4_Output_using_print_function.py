...
# and can be made to any character, integer or string as per our choice. The 'sep' parameter is used to achieve the same, it is found
# only in python 3.x or later. It is also used for formatting the output strings.
